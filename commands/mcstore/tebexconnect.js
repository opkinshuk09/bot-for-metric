...
module.exports = class TebexConnect extends Command {
  ...
  async run(message, args) {
    ...
    let tebexVerified = await db.get(`tebexVerified_${message.guild.id}`) || [];
    ...
    await db.push(`tebexVerified_${message.guild.id}`, {
  ...
  async slashRun(interaction, args) {
    ...
    let tebexVerified = await db.get(`tebexVerified_${interaction.guild.id}`) || [];
    ...
    await db.push(`tebexVerified_${interaction.guild.id}`, {
