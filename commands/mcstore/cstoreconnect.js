...
module.exports = class CraftingStoreConnect extends Command {
  ...
  async run(message, args) {
    ...
    let craftingVerified = await db.get(`craftingVerified_${message.guild.id}`) || [];
    ...
    await db.push(`craftingVerified_${message.guild.id}`, {
  ...
  async slashRun(interaction, args) {
    ...
    let craftingVerified = await db.get(`craftingVerified_${interaction.guild.id}`) || [];
    ...
    await db.push(`craftingVerified_${interaction.guild.id}`, {
