...
module.exports = class SellixConnect extends Command {
  ...
  async run(message, args) {
    ...
    let verifiedList = await db.get(`sellixVerified_${message.guild.id}`) || [];
    ...
    await db.push(`sellixVerified_${message.guild.id}`, {
  ...
  async slashRun(interaction, args) {
    ...
    let verifiedList = await db.get(`sellixVerified_${interaction.guild.id}`) || [];
    ...
    await db.push(`sellixVerified_${interaction.guild.id}`, {
